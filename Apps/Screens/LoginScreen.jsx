  ...
  return (
    ...
    <Image source={require('./../../assets/images/login2.png')}
        className="w-[220px] h-[460px]
         object-cover mt-10 rounded-xl "
         style={{borderWidth:4,borderColor:'#000',paddingTop:5}}
    />
    <View className="p-3 mt-[-20px] bg-blue-500 flex h-full rounded-t-3xl shadow-md">
        ...
        <TouchableOpacity onPress={onPress} className="p-4 bg-white rounded-full mt-5">
